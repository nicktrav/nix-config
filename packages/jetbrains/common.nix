# NOTE: This is lifted directly from nixpkgs so that we can reference it in
# default.nix.
#
# See here for the original:
# https://github.com/NixOS/nixpkgs/blob/21.05/pkgs/applications/editors/jetbrains/common.nix
