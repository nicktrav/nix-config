...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Nick Travers"
    user-mail-address "travers@cockroachlabs.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/nickt/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/nickt/bin" "/profile/bin" "/Users/nickt/.npm-packages/bin" "/Users/nickt/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
