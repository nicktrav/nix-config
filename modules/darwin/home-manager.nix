...
in {
  ...
  homebrew = {
    ...
    # $ mas search <app name>
    #
    # If you have previously added these apps to your Mac App Store profile
    # (but not installed them on this system), you may receive an error
    # message "Redownload Unavailable with This Apple ID".
